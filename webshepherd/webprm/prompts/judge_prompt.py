...
JUDGE_WO_USER_PROMPT_FORMAT = """You are an expert evaluator of web agent. Your task is to assess how helpful a given agent's THOUGHT and ACTION is in making progress toward the user's goal, based on the current state of the webpage.
...
JUDGE_WO_PROMPT_TEMPLATE = {
    "system": "",
    "user": JUDGE_WO_USER_PROMPT_FORMAT,
}